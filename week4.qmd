...
Since malaria is both a global and local challenge, certain goals should be considered to support Nusantara's sustainability, such as:
...
-   **Sentinel-2 (rainy season)**
    ...
    -   *Highlight water bodies and wetlands* – These serve as proxies for mosquito breeding sites.
...
-   **Digital Elevation Model (DEM) Data/Topography**
    ...
    -   Helps identify potential inundation areas, which could influence mosquito breeding patterns.
