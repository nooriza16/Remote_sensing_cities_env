...
Understanding the image classification using machine learning is also quite challenging for me, as they use new terminologies that I haven't heard before such as convolutional neural network, epoch, data training.
