...
If SAR is this good at penetrating objects and imaging at night, what kind of weaknesses does it have? I was thinking when backscattering signals bounce off back by so many things (many speckles- term for noise in radar), it must be challenging to analyze. Moreover, the appearance of SAR images as grayscale is also less intuitive. Apparently, this question has been explored by [@wang], they address then grayscale and speckle issues by applying convolutional neural nets (CNNs). I am not sure if I can fully understand what it means, but the intuition is to make SAR images appear more like the visible images by ) despeckled and colorized image.
